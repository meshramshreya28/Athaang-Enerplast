    ...
    <section className="relative min-h-screen flex flex-col justify-center bg-primary overflow-hidden py-24 md:py-0">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full mt-4 md:mt-16">
        ...
        >
          ...
          <p className="text-[16px] text-paragraph font-body mb-8 max-w-[550px] leading-[1.7] opacity-90 font-medium">
          ...
          <div className="flex flex-wrap gap-4 w-full mb-8">
            <button className="bg-brand-green text-white border border-transparent px-8 py-3 rounded-xl font-semibold text-[15px] min-w-[180px] flex items-center justify-center transition-all hover:bg-hover hover:scale-105 shadow-sm">
              Explore Products
            </button>
